...
십간과 십이지로 구성된 간지를 사용하여 60년을 주기로 
각 연도에 다음과 같이 이름을 부여한다: 최초 1년째는 "갑자"이고, 
2년째는 "을축", 3년째는 "병인" 과 같이 
...
gan = [str(i) for i in range(10)]
ji = [chr(j) for j in range(65, 77)]

gan_idx = 9
ji_idx = 5

gan_idx = (year - 2013 + gan_idx) % 10
ji_idx = (year - 2013 + ji_idx) % 12

print(f"{ji[ji_idx]}{gan[gan_idx]}")