...
E, S, M이 주어졌고, 1년이 준규가 사는 나라에서 1 1 1일때, 준규가 사는 나라에서 
...
e_num, s_num, m_num = 0, 0, 0
i = 1
while True:
    e_num = i % e_r if i % e_r != 0 else e_r
    s_num = i % s_r if i % s_r != 0 else s_r
    m_num = i % m_r if i % m_r != 0 else m_r
    if e_num == e and s_num == s and m_num == m:
        break
    i += 1
