...
if work_lang % day_lang == 0:
    re_lang = work_lang // day_lang
else:
    re_lang = (work_lang // day_lang) + 1

if work_math % day_math == 0:
    re_math = work_math // day_math
else:
    re_math = (work_math // day_math) + 1

result = 0

if re_lang >= re_math:
    result = vacation_days - re_lang
else:
    result = vacation_days - re_math
